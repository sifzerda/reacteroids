// src/renderers/ChargeBeamRenderer.jsx
...
export default function ChargeBeamRenderer() {
...
`
  ...
  const arrays = useMemo(() => ({
    ...
    forwards:
      geometry.attributes.forward.array,

    lengths:
      geometry.attributes.beamLength.array,

    widths:
      geometry.attributes.beamWidth.array,
